<template>
    <div class="menu-nav">
      <div class="nav_bar" :class="open ? 'opens' : ''" style="height: 680px">
        <div id="innerNav" class="innerNav" style="height: 100%; overflow-y:auto">
          <div
            class="nav_item"
  ...
  const prevPage = () => {
    ...
    const innerNav: any = document.getElementById('innerNav');
    innerNav.scrollTop = 0;
  }
  const nextPage = () => {
  ...
  .menu-nav .nav_bar .innerNav::-webkit-scrollbar {
    width: 1px;
  }
