<template>
  <div id="myChartRingFive" :style="{ width: '100%', height: '100%' }"></div>
</template>
...
let setOption = () => {
  const myChartRingFive = document.getElementById("myChartRingFive")
  if (myChartRingFive) {
    let myChart = echarts.init(myChartRingFive);
